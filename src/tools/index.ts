...
import { ContextManager, ContextEntry, MessageContent } from '../utils/context-manager.js';
import { SemanticSearch } from '../utils/semantic-search.js';
import { Logger } from '../utils/logger.js';

export async function registerTools(server: McpServer, contextManager: ContextManager, semanticSearch?: SemanticSearch) {
  ...
  server.tool(
    ...
    async (params: {
      ...
      try {
        ...
        let relevantContext: ContextEntry[] = [];
